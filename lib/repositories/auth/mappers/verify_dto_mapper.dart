...
import 'package:billit_now/services/auth/dto/verify_dto.dart';
import 'package:injectable/injectable.dart';

@singleton
class VerifyDtoMapper extends BaseDtoMapper<VerifyDto, VerifyInputModel> {
  @override
  VerifyInputModel fromDto(VerifyDto dto) {
    // TODO: implement fromDto
    throw UnimplementedError();
  }

  @override
  VerifyDto toDto(VerifyInputModel model) {
    return VerifyDto(
