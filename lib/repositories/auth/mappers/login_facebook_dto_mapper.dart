...
@singleton
class LoginFacebookDtoMapper extends BaseDtoMapper<LoginFacebookDto, LoginFacebookInputModel> {
  @override
  LoginFacebookInputModel fromDto(LoginFacebookDto dto) {
    // TODO: implement fromDto
    throw UnimplementedError();
  }

  @override
  LoginFacebookDto toDto(LoginFacebookInputModel model) {
